...
const Section2 = () => {
  return (
    <div className={styles.Section2}>
        <div className={styles.head}><h5 >Sponsor The Next Friday</h5>
        <h1>Why Sponsor <br/> Founders Friday?</h1></div>
        <div className={styles.container}> <div className={styles.card}>
        <div className={styles.circleRow}>
          <div className={styles.circle}><h3>Networking Opportunities</h3>
            <p>Connect with industry leaders, founders, and potential partners.</p>
          </div>
          <div className={styles.circle2}> <h3> Community Impact</h3>
            <p>Support the growth and development of the startup ecosystem.</p>
          </div>
        </div>
        <div className={styles.circleRow}>
          <div className={styles.circle2}>
            <h3>Brand Association</h3> <p>Align your brand with innovation and entrepreneurial success.</p></div>
          <div className={styles.circle}> <h3>Visibility</h3> <p>Gain exposure to a targeted audience of young professionals and entrepreneurs.</p></div>
        </div>
      </div>
